...
# my $sth = $dbh->prepare("SELECT biblionumber, marcxml FROM biblioitems where biblionumber > 100;");
...
sub addEbook {
    ...
    my $sf300a = getSubfield(getField($item->{biblio}->{marcxml}, '300'), 'a');
